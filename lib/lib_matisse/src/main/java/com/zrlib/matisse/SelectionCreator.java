...
import com.zrlib.matisse.engine.ImageEngine;
import com.zrlib.matisse.engine.impl.GlideEngine;
...
public final class SelectionCreator {
     ...
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator countable(boolean countable, boolean preCountable) {
        mSelectionSpec.countable = countable;
        mSelectionSpec.preCountable = preCountable;
        return this;
    }
    ...
    /**
     * Do you want to cut the picture.
     * <p>
     * If this value is set true,Only one picture can be selected at a time，
     *
     * @param enable Whether to enable clipping or not. Default value is false;
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator cutter(boolean enable) {
        mSelectionSpec.cutter = enable;
        return this;
    }
     ...
     *
     * @param cutterStrategy {@link CutterStrategy}, needed only when clipping is enabled.
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator cutterStrategy(CutterStrategy cutterStrategy) {
        mSelectionSpec.cutterStrategy = cutterStrategy;
        return this;
    }
     ...
     * @return
     */
    public SelectionCreator maxSelectableTips(String tips) {
        mSelectionSpec.maxSelectableTips = tips;
        return this;
    }
    ...
    public void forResult(int requestCode) {
        Context context = mMatisse.getContext();
        if (context != null && context instanceof FragmentActivity) {
            Fragment f = ((FragmentActivity) context).getSupportFragmentManager().getFragments().get(0);
            FragmentEx.startFragment(f,MatisseFragment.class);
        }
    }
