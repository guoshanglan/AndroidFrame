...
import static base2app.ex.ResourceKt.color;
...
public class MediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        mCheckView.setBackgroundColor(Color.parseColor("#33000000"));
        mCheckView.setDefaultColor(color(R.color.matisse_check_white));
