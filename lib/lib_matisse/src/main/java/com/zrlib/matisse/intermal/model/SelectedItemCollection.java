 ...
 */
package com.zrlib.matisse.intermal.model;
...
public class SelectedItemCollection {
    ...
    public IncapableCause isAcceptable(Item item) {
        if (maxSelectableReached()) {
            ...
            String maxSelectableTips = SelectionSpec.getInstance().maxSelectableTips;
            String cause = TextUtils.isEmpty(maxSelectableTips) ? String.format(ResourceKt.text(R.string.matisse_max_select_file), maxSelectable) : maxSelectableTips;
...
//            }
            ...
            return new IncapableCause(ResourceKt.text(R.string.matisse_cannot_same_time_select_pictures_and_videos));
        }
