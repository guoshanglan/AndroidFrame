package com.zhuorui.securties.debug.net.jsonviewer.view;
...
public class JsonItemView extends LinearLayout {
    ...
    public void showIcon(boolean isPlus) {
        ...
        mIvIcon.setContentDescription(ResourceKt.text(isPlus ? R.string.dk_jsonViewer_icon_plus : R.string.dk_jsonViewer_icon_minus));
    }
