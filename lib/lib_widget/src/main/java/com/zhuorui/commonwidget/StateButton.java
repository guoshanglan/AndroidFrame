 ...
 * 有圆角边框背景的Button
 */
public class StateButton extends AppCompatButton implements ZRSkinAble {
    ...
    private int mNormalTextColorId = 0;
    private int mPressedTextColorId = 0;
    private int mUnableTextColorId = 0;
    ...
    private int mNormalStrokeColorId = 0;
    private int mPressedStrokeColorId = 0;
    private int mUnableStrokeColorId = 0;
    ...
    private int mNormalBackgroundColorId = 0;
    private int mPressedBackgroundColorId = 0;
    private int mUnableBackgroundColorId = 0;
    ...
    private void setup(AttributeSet attrs) {
        ...
        mNormalTextColorId = a.getResourceId(R.styleable.StateButton_normalTextColor, 0);
        mPressedTextColorId = a.getResourceId(R.styleable.StateButton_pressedTextColor, 0);
        mUnableTextColorId = a.getResourceId(R.styleable.StateButton_unableTextColor, 0);

        mNormalTextColor = mNormalTextColorId == 0 ? mDefaultNormalTextColor : ResourceKt.color(mNormalTextColorId);
        mPressedTextColor = mPressedTextColorId == 0 ? mDefaultPressedTextColor : ResourceKt.color(mPressedTextColorId);
        mUnableTextColor = mUnableTextColorId == 0 ? mDefaultUnableTextColor : ResourceKt.color(mUnableTextColorId);
        setTextColor();
        ...
        mNormalBackgroundColorId = a.getResourceId(R.styleable.StateButton_normalBackgroundColor, 0);
        mPressedBackgroundColorId = a.getResourceId(R.styleable.StateButton_pressedBackgroundColor, 0);
        mUnableBackgroundColorId = a.getResourceId(R.styleable.StateButton_unableBackgroundColor, 0);

        mNormalBackgroundColor = getColorById(mNormalBackgroundColorId);
        mPressedBackgroundColor = getColorById(mPressedBackgroundColorId);
        mUnableBackgroundColor = getColorById(mUnableBackgroundColorId);
        ...
        mNormalStrokeColorId = a.getResourceId(R.styleable.StateButton_normalStrokeColor, 0);
        mPressedStrokeColorId = a.getResourceId(R.styleable.StateButton_pressedStrokeColor, 0);
        mUnableStrokeColorId = a.getResourceId(R.styleable.StateButton_unableStrokeColor, 0);

        mNormalStrokeColor = getColorById(mNormalStrokeColorId);
        mPressedStrokeColor = getColorById(mPressedStrokeColorId);
        mUnableStrokeColor = getColorById(mUnableStrokeColorId);
        setStroke();
    ...
    /**
     * color resource id to color int
     */
    private int getColorById(int colorId) {
        return colorId == 0 ? 0 : ResourceKt.color(colorId);
    }

    @Override
    public void applyUIMode(@Nullable Resources resources) {
        //apply text color
        int[] colors = new int[]{getColorById(mPressedTextColorId),
                getColorById(mPressedTextColorId), getColorById(mNormalTextColorId)
                , getColorById(mUnableTextColorId)};
        mTextColorStateList = new ColorStateList(states, colors);
        setTextColor(mTextColorStateList);

        //apply stroke color
        setStroke(mNormalBackground, getColorById(mNormalStrokeColorId), mNormalStrokeWidth);
        setStroke(mPressedBackground, getColorById(mPressedStrokeColorId), mPressedStrokeWidth);
        setStroke(mUnableBackground, getColorById(mUnableStrokeColorId), mUnableStrokeWidth);

        //apply background
        mNormalBackground.setColor(getColorById(mNormalBackgroundColorId));
        mPressedBackground.setColor(getColorById(mPressedBackgroundColorId));
        mUnableBackground.setColor(getColorById(mUnableBackgroundColorId));
