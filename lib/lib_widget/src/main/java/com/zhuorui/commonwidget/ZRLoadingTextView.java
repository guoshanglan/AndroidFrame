...
public class ZRLoadingTextView extends View {
    ...
    public ZRLoadingTextView(Context context, AttributeSet attrs) {
        ...
        String text = a.getString(R.styleable.ZRLoadingTextView_load_text);
        setText(text);
        mTextColorNormal = a.getColor(R.styleable.ZRLoadingTextView_text_color_normal, TEXT_COLOR_NORMAL);
        mTextColorHighLight = a.getColor(R.styleable.ZRLoadingTextView_text_color_hightlight, TEXT_COLOR_HIGHLIGHT);
        // 文字大小
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mStartY = getMeasuredHeight() / 2 - fm.descent + (fm.bottom - fm.top) / 2;
