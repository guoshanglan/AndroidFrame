package com.zrlib.permission.bean;
...
import com.zrlib.permission.PermissionUtil;
import com.zrlib.permission.R;
...
public class Permission {
    ...
    public String getPermissionNameDesc() {
        Context context = PermissionUtil.getInstance().getContext();
        if (null == context) {
        ...
        switch (permissionName) {
            ...
            case Manifest.permission.CAMERA:
                desc = ResourceKt.text(R.string.permission_camera);
                break;
            case Manifest.permission_group.CONTACTS:
            case Manifest.permission.READ_CONTACTS:
            case Manifest.permission.WRITE_CONTACTS:
            case Manifest.permission.GET_ACCOUNTS:
                desc = ResourceKt.text(R.string.permission_contact);
                break;
            ...
            case Manifest.permission.PROCESS_OUTGOING_CALLS:
                desc = ResourceKt.text(R.string.permission_call);
                break;
            case Manifest.permission_group.STORAGE:
            case Manifest.permission.WRITE_EXTERNAL_STORAGE:
            case Manifest.permission.READ_EXTERNAL_STORAGE:
                desc = ResourceKt.text(R.string.permission_storage);
                break;
            case Manifest.permission_group.LOCATION:
            case Manifest.permission.ACCESS_FINE_LOCATION:
            case Manifest.permission.ACCESS_COARSE_LOCATION:
                desc = ResourceKt.text(R.string.permission_location);
                break;
            case Manifest.permission.READ_PHONE_STATE:
                desc = ResourceKt.text(R.string.permission_phone_status);
                break;
            case Manifest.permission_group.CALENDAR:
            case Manifest.permission.READ_CALENDAR:
            case Manifest.permission.WRITE_CALENDAR:
                desc = ResourceKt.text(R.string.permission_calender);
                break;
            case Manifest.permission_group.MICROPHONE:
            case Manifest.permission.RECORD_AUDIO:
                desc = ResourceKt.text(R.string.permission_microphone);
                break;
            case Manifest.permission_group.SENSORS:
            case Manifest.permission.BODY_SENSORS:
                desc = ResourceKt.text(R.string.permission_sensor);
                break;
            ...
            case Manifest.permission.RECEIVE_MMS:
                desc = ResourceKt.text(R.string.permission_sms);
                break;
            default:
                desc = ResourceKt.text(R.string.permission_undefined);
                break;
        }
        return desc;
    }
