...
public class DatePicker extends LinearLayout implements YearPicker.OnYearSelectedListener,
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        mYearPicker.setTextGradual(true);
        mMonthPicker.setTextGradual(true);
        mDayPicker.setTextGradual(true);
    }
...
//        mDayPicker.setIndicatorText("日");
    ...
    public void setSelectedItemTextStyle(Typeface typeface) {
        mDayPicker.setSelectedItemTextStyle(typeface);
        mMonthPicker.setSelectedItemTextStyle(typeface);
        mYearPicker.setSelectedItemTextStyle(typeface);
    }
